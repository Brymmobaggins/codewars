...
/* The function grabDoll takes a parameter of dolls, it a string's of array. 
i defined a dollBag with an empty array.
i loop through the dolls with a for loop method to access each element in the dolls array,
then check if eacgh element is "Hello Kitty or barbie doll", if it si true, i pushed a element in the the bag, it is false,  i used "continue" to skip. if the bag has three element i broke out of the loop, if is not full it continue pushing inside the bag. lastly, i returned the bag after the loop.
*/
