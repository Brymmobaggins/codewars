...
console.log(getLength([13, 45, 56, 7, 7, 7,])) // 6

function getFirst(array) {
   return array[0]

}
console.log(getFirst([13, 45, 56, 4, 67,])) // 13

function lastArr(array) {
   return array[array.length - 1]

}
console.log(lastArr([13, 45, "45", true, false, " "]))

function pushElement(array){
   array.push(7)
   return array
}
console.log(pushElement([4,56,6, "hloo"]))

function popElement(array){
   array.pop()
   return array
}
console.log(popElement([45, 56, 6, 56, "45"]))